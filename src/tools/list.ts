          ...
          content: [
            {
              ...
              text: JSON.stringify({
                ...
                templates,
                recommended: [
                  "Time Profiler - CPU hotspots and slow functions",
                  "SwiftUI - View body re-evaluation performance",
                  "Animation Hitches - Dropped frames, scroll jank",
                  "Allocations - Heap memory usage",
